...
declare namespace escpos {
    export namespace Constants {
        ...
        export enum TXT_STYLE {
            ...
            UNDERL2 = 'U2',
            BOLD_ITALIC = 'BI',
            BOLD_ITALIC_UNDERL = 'BIU',
            BOLD_ITALIC_UNDERL2 = 'BIU2',
            BOLD_UNDERL = 'BU',
            BOLD_UNDERL2 = 'BU2',
            ITALIC_UNDERL = 'IU',
            ITALIC_UNDERL2 = 'IU2',
    ...
    export class Printer {
         ...
         * @return {[Printer]} printer  [the escpos printer instance]
         */
        public control(ctrl: Constants.FEED_CONTROL_TYPE): Printer;
         ...
         * @return {[Printer]} printer  [the escpos printer instance]
         */
        public align(align: Constants.TXT_ALIGN): Printer;
    ...
    export class command extends Commands{}
